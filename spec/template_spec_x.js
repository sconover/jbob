...
describe("Jaml.Template", function() {
  ...
  describe("calling context is available to jaml templates", function() {
  
    it("is able to use values of variables defined outside of the template", function(){
      var myColor = "purple"
      var yourColor = "orange"
